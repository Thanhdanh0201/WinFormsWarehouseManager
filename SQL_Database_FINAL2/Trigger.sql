...
-- [TRIGGER] Tự động tạo phiếu nhập khi tạo Sản phẩm mới
-- Reset số lượng về 0 TRƯỚC khi tạo phiếu nhập để tránh cộng dồn sai.
...
BEGIN
    ...
    BEGIN
        ...
        -- Để lát nữa khi BƯỚC 2 chạy, Trigger nhập kho sẽ cộng số lượng vào.
        UPDATE Products 
        SET SoLuong = 0 
        FROM Products p
